        ...
        <div className="d-flex container-fluid pb">
            <div className="container">
                ...
                <h5 className="p-f m-t">
                        ...
                        Project: URL Generator </h5>
                    <p className="l">SEO Company Link Generator</p> 
                    <h5 id="list-item-1" className="p-f t-s">How it works</h5>
                    <p className="p-f">It generates URL domain name for company marketing promotion. Try it yourself by clicking the view live button below.</p>
                    <div className="row justify-content-center">
                    <div className="col-auto">
                      <a href="https://github.com/markjay18/url-generator" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
                    ...
                    <div className="col-auto">
                      <a href="https://markjay18.github.io/url-generator/" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse">
