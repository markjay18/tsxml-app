        ...
        <div className="d-flex container-fluid pb">
            <div className="container">
                ...
                <h5 className="p-f m-t">
                        ...
                        Project: Multi Swiper </h5>
                    <p className="l">SEO Company Marketing Promotion</p> 
                    <h5 id="list-item-1" className="p-f t-s">How it works</h5>
                    <p className="p-f">It's a multi swiper company solution for marketing promotions, games. Below is the source code and live.</p>
                    <div className="row justify-content-center">
                    <div className="col-auto">
                      <a href="https://github.com/markjay18/multi-swiper" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
                    ...
                    <div className="col-auto">
                      <a href="https://markjay18.github.io/multi-swiper/" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse">
