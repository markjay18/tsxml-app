        ...
        <div className="d-flex container-fluid pb">
            <div className="container">
                ...
                <h5 className="p-f m-t">
                        ...
                        Project: Live Time </h5>
                    <p className="l">Personal Project from Scratch</p> 
                    <h5 id="list-item-1" className="p-f t-s">How it works</h5>
                    <div className="rules">
                        <div className="p-xx">
                            <p className="p-con">I had developed this application when we are conducting online raffle draw.</p>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                    <div className="col-auto">
                      <a href="https://github.com/markjay18/time" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
                    ...
                    <div className="col-auto">
                      <a href="https://markjay18.github.io/time/" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse">
