        ...
        <div className="d-flex container-fluid pb">
            <div className="container">
                ...
                <h5 className="p-f m-t">
                        ...
                        Project: Puppeteer - Automated Link Checker</h5>  
                    <p className="l">Self made program from scratch</p> 
                    <h5 id="list-item-1" className="p-f t-s">How it works</h5>
                    <p className="p-f t-s">Technical Solution</p>
                    <li className="p-f">In this project, a scheduled task is set to run a .bat file every midnight. This .bat file automatically opens the Google Chrome browser and launches the checker website, defining the URLs or links to be tested. </li>
                    <li className="p-f">To achieve this, you can use JavaScript with Node.js to create an asynchronous function that tests each URL one by one using the async and await syntax. This script will check the response time (ping) for each URL and report any issues. If a URL is abnormal, you can log it or take appropriate action.</li>
                    <div className="row justify-content-center">
                    <div className="col-auto">
                      <a href="https://github.com/markjay18/puppeteer-bot-nodejs" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
...
export default PuppeteerContent;