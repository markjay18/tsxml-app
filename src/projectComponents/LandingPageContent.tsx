      ...
      <div className="container">
        <div className="f-w">
          <h5 className="p-f m-t">
            ...
            Project: Landing Page App</h5>
          <p className="l">SEO Company Marketing Website</p>
          <h5 id="list-item-1" className="p-f t-s">How it works</h5>
          <li className="p-f">This landing page website build for company marketing solution. Style with css, Html elements, Javascript for functionality and of JQuery.</li>
          <h5 id="list-item-4" className="p-f t-s">Warning</h5>
          <div className="rules1">
            <div className="p-xx">
              <p className="p-con">This application's policy is restricted by the company. For code viewing, please note that it is for portfolio purposes only. Contact the owner for more information on this project.</p>
            </div>
          </div>
          <div className="row justify-content-center">
            <div className="col-auto">
              <a href="https://github.com/markjay18/landing-page" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
