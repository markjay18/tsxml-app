        ...
        <div className="d-flex container-fluid pb">
            <div className="container">
                ...
                <h5 className="p-f m-t">
                        ...
                        Project: Quiz App</h5>
                    <p className="l">From Scratch</p> 
                    <h5 id="list-item-1" className="p-f t-s">How it works</h5>
                    <li className="p-f">The rules of the game is written before getting started. The main goal of the application is to enable users to practice for subjective tests conducted for admissions and recruitment, with focus on Computer science field.</li>
                    <div className="row justify-content-center">
                    <div className="col-auto">
                      <a href="https://github.com/markjay18/quiz-app" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="false" aria-controls="collapse">
                    ...
                    <div className="col-auto">
                      <a href="https://markjay18.github.io/quiz-app" target="_blank"><button type='button' className='all px-4 m-tb' data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse">
